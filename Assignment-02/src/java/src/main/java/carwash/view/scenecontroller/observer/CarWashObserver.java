...
public final class CarWashObserver implements PropertyChangeListener {
    ...
    public void propertyChange(final PropertyChangeEvent arg0) {
        logger.info("Property changed: {} {}", arg0.getPropertyName(), arg0.getNewValue());
        // if (arg0.getPropertyName().equals(ValueType.TEMPERATURE.getValue())) {
        //     this.mainSceneSetter.setTemperature(arg0.getNewValue().toString());
        // } else if (arg0.getPropertyName().equals(ValueType.STATUS.getValue())) {
